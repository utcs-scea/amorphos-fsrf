...
# More custom warnings
set_msg_config -id {Vivado_Tcl 4-391} -suppress
...
if {$implement} {
   ...
   ##############################
   set SLACK [get_property SLACK [get_timing_paths -setup -hold]]
   ...
   #file link -force -hard $CL_DIR/build/checkpoints/last_routed.dcp $CL_DIR/build/checkpoints/${timestamp}.SH_CL_routed.dcp
