...
foreach file [glob $CL_DIR/design/hls_hll/fpga/*.tcl] {
	source $file
}
...
#]
#source $CL_DIR/design/aos/cl_axi_interconnect.tcl
#generate_target all [get_files $CL_DIR/design/aos/cl_axi_interconnect/cl_axi_interconnect.bd]
