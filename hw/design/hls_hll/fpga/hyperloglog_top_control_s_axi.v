...
// ==============================================================
`timescale 1ns/1ps
module hyperloglog_top_control_s_axi
#(parameter
    ...
    output wire [63:0]                   input_s,
    output wire [63:0]                   N_s
);
//------------------------Address Info-------------------
...
//        others   - reserved
// 0x30 : Data signal of input_s
//        bit 63~0 - input_s[63:0] (Read/Write)
// 0x38 : reserved
// 0x40 : Data signal of N_s
...
localparam
    ...
    ADDR_INPUT_S_DATA_0 = 7'h30,
    ADDR_INPUT_S_CTRL   = 7'h38,
    ADDR_N_S_DATA_0     = 7'h40,
    ADDR_N_S_CTRL       = 7'h48,
    WRIDLE              = 2'd0,
    WRDATA              = 2'd1,
    WRRESP              = 2'd2,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_INPUT_S_DATA_0: begin
                    rdata <= int_input_s[63:0];
                end
                ADDR_N_S_DATA_0: begin
                    rdata <= int_N_s[63:0];
                end
            endcase
        end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_INPUT_S_DATA_0)
            int_input_s[63:0] <= (WDATA[63:0] & wmask) | (int_input_s[63:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_N_S_DATA_0)
            int_N_s[63:0] <= (WDATA[63:0] & wmask) | (int_N_s[63:0] & ~wmask);
    end
end
