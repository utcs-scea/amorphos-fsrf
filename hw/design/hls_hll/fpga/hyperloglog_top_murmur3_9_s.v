...
module hyperloglog_top_murmur3_9_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        N_out_full_n,
        N_out_write,
        dataFifo_V_data_V_9_dout,
        dataFifo_V_data_V_9_empty_n,
        dataFifo_V_data_V_9_read,
        dataFifo_V_valid_V_9_dout,
        dataFifo_V_valid_V_9_empty_n,
        dataFifo_V_valid_V_9_read,
        dataFifo_V_last_V_9_dout,
        dataFifo_V_last_V_9_empty_n,
        dataFifo_V_last_V_9_read,
        hashFifo_din,
        hashFifo_full_n,
        hashFifo_write
);
...
input   N_out_full_n;
output   N_out_write;
input  [31:0] dataFifo_V_data_V_9_dout;
input   dataFifo_V_data_V_9_empty_n;
output   dataFifo_V_data_V_9_read;
input  [0:0] dataFifo_V_valid_V_9_dout;
input   dataFifo_V_valid_V_9_empty_n;
output   dataFifo_V_valid_V_9_read;
input  [0:0] dataFifo_V_last_V_9_dout;
input   dataFifo_V_last_V_9_empty_n;
output   dataFifo_V_last_V_9_read;
output  [63:0] hashFifo_din;
input   hashFifo_full_n;
output   hashFifo_write;
...
reg N_read;
reg N_out_write;
reg dataFifo_V_data_V_9_read;
reg dataFifo_V_valid_V_9_read;
reg dataFifo_V_last_V_9_read;
reg hashFifo_write;
...
reg   [14:0] r_9_reg_379;
reg   [16:0] tmp_2_reg_384;
wire  signed [31:0] ret_fu_191_p3;
reg   [12:0] r_s_reg_395;
reg   [18:0] tmp_4_reg_400;
wire  signed [31:0] h1_V_3_fu_279_p2;
reg  signed [31:0] h1_V_3_reg_405;
wire  signed [31:0] h1_V_5_fu_304_p2;
reg  signed [31:0] h1_V_5_reg_410;
wire   [31:0] h1_V_7_fu_329_p2;
reg   [31:0] h1_V_7_reg_415;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_1_i_i_reg_369 <= dataFifo_V_valid_V_9_dout;
        p_2_i_i_reg_374 <= dataFifo_V_last_V_9_dout;
        tmp_data_V_reg_363 <= dataFifo_V_data_V_9_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln51_reg_359_pp0_iter5_reg == 1'd0))) begin
        r_9_reg_379 <= {{grp_fu_161_p2[31:17]}};
        tmp_2_reg_384 <= {{grp_fu_166_p2[31:15]}};
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln51_reg_359_pp0_iter10_reg == 1'd0))) begin
        r_s_reg_395 <= {{grp_fu_197_p2[31:19]}};
...
always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_data_V_9_blk_n = dataFifo_V_data_V_9_empty_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_data_V_9_read = 1'b1;
    end else begin
        dataFifo_V_data_V_9_read = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_last_V_9_blk_n = dataFifo_V_last_V_9_empty_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_last_V_9_read = 1'b1;
    end else begin
        dataFifo_V_last_V_9_read = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_valid_V_9_blk_n = dataFifo_V_valid_V_9_empty_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_valid_V_9_read = 1'b1;
    end else begin
        dataFifo_V_valid_V_9_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln51_reg_359_pp0_iter22_reg == 1'd0) & (ap_enable_reg_pp0_iter23 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
        hashFifo_blk_n = hashFifo_full_n;
    end else begin
        hashFifo_blk_n = 1'b1;
    end
end
...
assign add_ln213_fu_247_p2 = ($signed(ret_1_fu_235_p2) + $signed(32'd3864292196));
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln51_reg_359_pp0_iter22_reg == 1'd0) & (ap_enable_reg_pp0_iter23 == 1'b1) & (hashFifo_full_n == 1'b0)) | ((icmp_ln51_reg_359 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (io_acc_block_signal_op49 == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln51_reg_359_pp0_iter22_reg == 1'd0) & (ap_enable_reg_pp0_iter23 == 1'b1) & (hashFifo_full_n == 1'b0)) | ((icmp_ln51_reg_359 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (io_acc_block_signal_op49 == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln51_reg_359_pp0_iter22_reg == 1'd0) & (ap_enable_reg_pp0_iter23 == 1'b1) & (hashFifo_full_n == 1'b0)) | ((icmp_ln51_reg_359 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (io_acc_block_signal_op49 == 1'b0)));
end
...
always @ (*) begin
    ap_block_state25_pp0_stage0_iter23 = ((icmp_ln51_reg_359_pp0_iter22_reg == 1'd0) & (hashFifo_full_n == 1'b0));
end
...
assign h1_V_1_fu_253_p2 = (add_ln213_fu_247_p2 + shl_ln213_fu_241_p2);

assign h1_V_2_fu_259_p2 = (h1_V_1_fu_253_p2 ^ 32'd4);

assign h1_V_3_fu_279_p2 = (zext_ln1497_fu_275_p1 ^ h1_V_2_fu_259_p2);

assign h1_V_5_fu_304_p2 = (zext_ln1497_1_fu_300_p1 ^ grp_fu_285_p2);

assign h1_V_7_fu_329_p2 = (zext_ln1497_2_fu_325_p1 ^ grp_fu_310_p2);

assign hashFifo_din = tmp_fu_335_p5;

assign i_1_fu_138_p2 = (i_reg_127 + 64'd1);

assign icmp_ln51_fu_144_p2 = ((i_reg_127 == N_read_reg_349) ? 1'b1 : 1'b0);

assign io_acc_block_signal_op49 = (dataFifo_V_valid_V_9_empty_n & dataFifo_V_last_V_9_empty_n & dataFifo_V_data_V_9_empty_n);

assign or_ln_fu_229_p3 = {{tmp_4_reg_400}, {r_s_reg_395}};

assign r_2_fu_290_p4 = {{grp_fu_285_p2[31:13]}};

assign r_3_fu_315_p4 = {{grp_fu_310_p2[31:16]}};

assign r_fu_265_p4 = {{h1_V_2_fu_259_p2[31:16]}};

assign ret_1_fu_235_p2 = (or_ln_fu_229_p3 ^ 32'd344064);

assign ret_fu_191_p3 = {{tmp_2_reg_384}, {r_9_reg_379}};

assign shl_ln213_fu_241_p2 = ret_1_fu_235_p2 << 32'd2;

assign start_out = real_start;

assign tmp_fu_335_p5 = {{{{p_2_i_i_reg_374_pp0_iter22_reg}, {7'd0}}, {p_1_i_i_reg_369_pp0_iter22_reg}}, {h1_V_7_reg_415}};

assign zext_ln1497_1_fu_300_p1 = r_2_fu_290_p4;

assign zext_ln1497_2_fu_325_p1 = r_3_fu_315_p4;

assign zext_ln1497_fu_275_p1 = r_fu_265_p4;

endmodule //hyperloglog_top_murmur3_9_s
