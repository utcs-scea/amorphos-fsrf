...
module hyperloglog_top_murmur3_11_s (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
        ...
        N_out_full_n,
        N_out_write,
        dataFifo_V_data_V_11_dout,
        dataFifo_V_data_V_11_empty_n,
        dataFifo_V_data_V_11_read,
        dataFifo_V_valid_V_11_dout,
        dataFifo_V_valid_V_11_empty_n,
        dataFifo_V_valid_V_11_read,
        dataFifo_V_last_V_11_dout,
        dataFifo_V_last_V_11_empty_n,
        dataFifo_V_last_V_11_read,
        hashFifo_6_din,
        hashFifo_6_full_n,
        hashFifo_6_write
);
...
input   N_out_full_n;
output   N_out_write;
input  [31:0] dataFifo_V_data_V_11_dout;
input   dataFifo_V_data_V_11_empty_n;
output   dataFifo_V_data_V_11_read;
input  [0:0] dataFifo_V_valid_V_11_dout;
input   dataFifo_V_valid_V_11_empty_n;
output   dataFifo_V_valid_V_11_read;
input  [0:0] dataFifo_V_last_V_11_dout;
input   dataFifo_V_last_V_11_empty_n;
output   dataFifo_V_last_V_11_read;
output  [63:0] hashFifo_6_din;
input   hashFifo_6_full_n;
output   hashFifo_6_write;
...
reg N_read;
reg N_out_write;
reg dataFifo_V_data_V_11_read;
reg dataFifo_V_valid_V_11_read;
reg dataFifo_V_last_V_11_read;
reg hashFifo_6_write;
...
reg   [12:0] r_28_reg_395;
reg   [18:0] tmp_12_reg_400;
wire  signed [31:0] h1_V_94_fu_279_p2;
reg  signed [31:0] h1_V_94_reg_405;
wire  signed [31:0] h1_V_96_fu_304_p2;
reg  signed [31:0] h1_V_96_reg_410;
wire   [31:0] h1_V_98_fu_329_p2;
reg   [31:0] h1_V_98_reg_415;
reg    ap_block_state1;
...
wire   [31:0] ret_14_fu_235_p2;
wire   [31:0] add_ln213_fu_247_p2;
wire   [31:0] shl_ln213_fu_241_p2;
wire   [31:0] h1_V_92_fu_253_p2;
wire   [31:0] h1_V_93_fu_259_p2;
wire   [15:0] r_fu_265_p4;
wire   [31:0] zext_ln1497_fu_275_p1;
wire   [31:0] grp_fu_285_p2;
wire   [18:0] r_29_fu_290_p4;
wire   [31:0] zext_ln1497_27_fu_300_p1;
wire  signed [30:0] grp_fu_310_p1;
wire   [31:0] grp_fu_310_p2;
wire   [15:0] r_30_fu_315_p4;
wire   [31:0] zext_ln1497_28_fu_325_p1;
...
hyperloglog_top_mul_32s_32s_32_5_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
mul_32s_32s_32_5_1_U292(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(h1_V_94_reg_405),
    .din1(32'd2246822507),
    .ce(grp_fu_285_ce),
    .dout(grp_fu_285_p2)
);
...
hyperloglog_top_mul_32s_31s_32_5_1 #(
    ...
    .din1_WIDTH( 31 ),
    .dout_WIDTH( 32 ))
mul_32s_31s_32_5_1_U293(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(h1_V_96_reg_410),
    .din1(grp_fu_310_p1),
    .ce(grp_fu_310_ce),
    .dout(grp_fu_310_p2)
);
...
always @ (posedge ap_clk) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_1_i_i_reg_369 <= dataFifo_V_valid_V_11_dout;
        p_2_i_i_reg_374 <= dataFifo_V_last_V_11_dout;
        tmp_data_V_reg_363 <= dataFifo_V_data_V_11_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln51_reg_359_pp0_iter10_reg == 1'd0))) begin
        r_28_reg_395 <= {{grp_fu_197_p2[31:19]}};
        tmp_12_reg_400 <= {{grp_fu_203_p2[31:13]}};
    end
end
...
always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_data_V_11_blk_n = dataFifo_V_data_V_11_empty_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_data_V_11_read = 1'b1;
    end else begin
        dataFifo_V_data_V_11_read = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_last_V_11_blk_n = dataFifo_V_last_V_11_empty_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_last_V_11_read = 1'b1;
    end else begin
        dataFifo_V_last_V_11_read = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_valid_V_11_blk_n = dataFifo_V_valid_V_11_empty_n;
    end else begin
...
always @ (*) begin
    if (((icmp_ln51_reg_359 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        dataFifo_V_valid_V_11_read = 1'b1;
    end else begin
        dataFifo_V_valid_V_11_read = 1'b0;
    end
end
...
assign add_ln213_fu_247_p2 = ($signed(ret_14_fu_235_p2) + $signed(32'd3864292196));
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln51_reg_359_pp0_iter22_reg == 1'd0) & (ap_enable_reg_pp0_iter23 == 1'b1) & (hashFifo_6_full_n == 1'b0)) | ((icmp_ln51_reg_359 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (io_acc_block_signal_op49 == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln51_reg_359_pp0_iter22_reg == 1'd0) & (ap_enable_reg_pp0_iter23 == 1'b1) & (hashFifo_6_full_n == 1'b0)) | ((icmp_ln51_reg_359 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (io_acc_block_signal_op49 == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln51_reg_359_pp0_iter22_reg == 1'd0) & (ap_enable_reg_pp0_iter23 == 1'b1) & (hashFifo_6_full_n == 1'b0)) | ((icmp_ln51_reg_359 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (io_acc_block_signal_op49 == 1'b0)));
end
...
always @ (*) begin
    ap_block_state25_pp0_stage0_iter23 = ((icmp_ln51_reg_359_pp0_iter22_reg == 1'd0) & (hashFifo_6_full_n == 1'b0));
end
...
assign h1_V_92_fu_253_p2 = (add_ln213_fu_247_p2 + shl_ln213_fu_241_p2);

assign h1_V_93_fu_259_p2 = (h1_V_92_fu_253_p2 ^ 32'd4);

assign h1_V_94_fu_279_p2 = (zext_ln1497_fu_275_p1 ^ h1_V_93_fu_259_p2);

assign h1_V_96_fu_304_p2 = (zext_ln1497_27_fu_300_p1 ^ grp_fu_285_p2);

assign h1_V_98_fu_329_p2 = (zext_ln1497_28_fu_325_p1 ^ grp_fu_310_p2);

assign hashFifo_6_din = tmp_fu_335_p5;

assign i_14_fu_138_p2 = (i_reg_127 + 64'd1);

assign icmp_ln51_fu_144_p2 = ((i_reg_127 == N_read_reg_349) ? 1'b1 : 1'b0);

assign io_acc_block_signal_op49 = (dataFifo_V_valid_V_11_empty_n & dataFifo_V_last_V_11_empty_n & dataFifo_V_data_V_11_empty_n);

assign or_ln_fu_229_p3 = {{tmp_12_reg_400}, {r_28_reg_395}};

assign r_29_fu_290_p4 = {{grp_fu_285_p2[31:13]}};

assign r_30_fu_315_p4 = {{grp_fu_310_p2[31:16]}};

assign r_fu_265_p4 = {{h1_V_93_fu_259_p2[31:16]}};

assign ret_14_fu_235_p2 = (or_ln_fu_229_p3 ^ 32'd344064);

assign ret_fu_191_p3 = {{tmp_s_reg_384}, {r_s_reg_379}};

assign shl_ln213_fu_241_p2 = ret_14_fu_235_p2 << 32'd2;

assign start_out = real_start;

assign tmp_fu_335_p5 = {{{{p_2_i_i_reg_374_pp0_iter22_reg}, {7'd0}}, {p_1_i_i_reg_369_pp0_iter22_reg}}, {h1_V_98_reg_415}};

assign zext_ln1497_27_fu_300_p1 = r_29_fu_290_p4;

assign zext_ln1497_28_fu_325_p1 = r_30_fu_315_p4;

assign zext_ln1497_fu_275_p1 = r_fu_265_p4;

endmodule //hyperloglog_top_murmur3_11_s
