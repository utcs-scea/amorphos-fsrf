...
// ==============================================================
`timescale 1ns/1ps
module sha256_fpga_control_s_axi
#(parameter
...
// 0x48 : Data signal of mem
//        bit 63~0 - mem[63:0] (Read/Write)
// 0x50 : reserved
// 0x58 : Data signal of words
...
localparam
    ...
    ADDR_MEM_DATA_0   = 7'h48,
    ADDR_MEM_CTRL     = 7'h50,
    ADDR_WORDS_DATA_0 = 7'h58,
    ADDR_WORDS_CTRL   = 7'h60,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_MEM_DATA_0)
            int_mem[63:0] <= (WDATA[63:0] & wmask) | (int_mem[63:0] & ~wmask);
    end
end
